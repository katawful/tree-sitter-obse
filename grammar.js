...
module.exports = grammar({
  ...
  rules: {
    ...
    _expression: $ => prec(PREC.TOP, choice(
      $._operands,
      prec(PREC.TOP, $._paren_operands),
      prec.left($.binary_operator),
      $._unary_expr,
      $._paren_expression,
    )),
    _paren_expression: $ => prec(PREC.TOP, seq(
      '(',
      repeat($._expression),
      ')',
    )),

    _operands: $ => prec(PREC.PLAIN, choice(
      ...
      field('function', $._function),
      field('user_function', $.user_function),
      field('option', $.opt),
    )),
    _paren_operands: $ => prec(PREC.BOTTOM, seq(
      '(',
      repeat($._operands),
      ')',
    )),
    ...
    _function: $ => prec.left(PREC.PLAIN, seq(choice(
