...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 1, .production_id = 17),
  [62] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable, 1, .production_id = 17),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_var, 4, .production_id = 26),
  [66] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_array_var, 4, .production_id = 26),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script_file, 1, .production_id = 1),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 1, .production_id = 16),
  [72] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable, 1, .production_id = 16),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal, 1),
  [76] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_literal, 1),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 1, .production_id = 15),
  [80] = {.entry = {.count = 1, .reusable = true}}, SHIFT(53),
  [82] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable, 1, .production_id = 15),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpreted, 1, .production_id = 18),
  [86] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interpreted, 1, .production_id = 18),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpreted, 1, .production_id = 23),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interpreted, 1, .production_id = 23),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declarator, 1, .production_id = 22),
  [94] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declarator, 1, .production_id = 22),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declarator, 1, .production_id = 21),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declarator, 1, .production_id = 21),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declarator, 1, .production_id = 20),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declarator, 1, .production_id = 20),
  ...
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, .production_id = 8),
  [142] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, .production_id = 8), SHIFT_REPEAT(61),
  [145] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, .production_id = 8), SHIFT_REPEAT(62),
  [148] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, .production_id = 8), SHIFT_REPEAT(6),
  [151] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, .production_id = 8), SHIFT_REPEAT(46),
  [154] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, .production_id = 8), SHIFT_REPEAT(45),
  ...
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body, 1, .production_id = 11),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_body, 1, .production_id = 11),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body, 1, .production_id = 14),
  [187] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_body, 1, .production_id = 14),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body, 1),
  [191] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_body, 1),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body, 1, .production_id = 10),
  [195] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_body, 1, .production_id = 10),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_statement, 4, .production_id = 25),
  [199] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_statement, 4, .production_id = 25),
  ...
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1, .production_id = 12),
  [211] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement, 1, .production_id = 12),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1, .production_id = 13),
  [215] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement, 1, .production_id = 13),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 1, .production_id = 2),
  [219] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 1, .production_id = 2),
  ...
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_set_statement, 4, .production_id = 25),
  [235] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_set_statement, 4, .production_id = 25),
